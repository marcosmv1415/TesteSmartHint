$(document).ready(function () {
    ...
    AjaxUploadImagemCliente();
});

function AjaxUploadImagemCliente() {
    ...
    $(".btn-imagem-excluir").click(function () {
        ...
        $.ajax({
            type: "GET",
            url: "/Colaborador/ImagemCliente/Deletar?caminho=" + CampoHidden.val(),
            error: function () {
    ...
    $(".input-file").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "/Cliente/ImagemCliente/Armazenar",
            data: Formulario,
            contentType: false,
            processData: false,
            error: function () {
